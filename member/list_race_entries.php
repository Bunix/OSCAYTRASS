...
<?php 
    ...
    $tid = mysqli_escape_string($db, $_GET["list_entries"]);   
  ...
  ?>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="list-race?view_id=<?php echo $cid;?>">Back</a></li>
    </div>
  </div>
</nav>
...
<?php
$no_race_query ="SELECT count(rid) as entry FROM race_entries where cid = $cid and rid = '".$_GET['list_entries']."'";  
