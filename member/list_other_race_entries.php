  ...
  ?>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="list-other-race?view_other_id=<?php echo $cid;?>">Back</a></li>
    </div>
  </div>
</nav>
...
<?php
$no_race_query ="SELECT count(rid) as entry FROM other_race_entries where cid = $cid and rid = '".$_GET['list_entries']."'";  
...
<div class="container">
  ...
  <tfoot>
    ...
    <?php                        
        // list of entries
        $sql = "SELECT * FROM other_race_entries where rid = '".$_GET['list_entries']."' and cid = '".$cid."'";
