...
<div class="container-fluid">
  ...
  <tfoot>
    ...
    <?php                        
       ...
       $dsql = "SELECT *, (TIME_TO_SEC(time_arrived) - TIME_TO_SEC(time_release))/60 as minutes, distance/((TIME_TO_SEC(time_arrived) - TIME_TO_SEC(time_release))/60) as speed FROM other_race_result where rid = '".$_GET['result_id']."' and cid = '".$cid."' order by speed desc";
