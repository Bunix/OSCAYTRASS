...
if ($login_access_id != 3) {
 ...
 $query ="SELECT *, date_format(date_hatched, '%e-%b-%y') as datehatched FROM p_details where uid = $login_id and status = 'Active' and gender = 'H'";  
...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">Hen(s)</h1>
          <!-- DataTales -->
