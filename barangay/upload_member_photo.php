  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="barangay-members">Back</a></li>
    </div>
  </div>
</nav>

    <h4 align="center">Upload Photo</h4>
...
$query10 = "select * from club_members where id = '$member_id'";
        ...
        // Check if file already exists
            move_uploaded_file($tmp, $target_dir .$name);  
               ...
               $rename = $target_dir.$name;
                 ...
                 $sql = "UPDATE club_members SET photo = '".$rename."'  where id = '".$hidid."'";
                  mysqli_query($db,$sql);
