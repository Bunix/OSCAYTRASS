...
$delete_id = mysqli_real_escape_string($db, $_GET["delete_id"]);
 ...
 $sql_query="DELETE FROM race WHERE id='".$delete_id."'";
 mysqli_query($db, $sql_query);

 $sql_query2="DELETE FROM race_entries WHERE rid='".$delete_id."'";
 mysqli_query($db, $sql_query2);

 $sql_query3="DELETE FROM race_result WHERE rid='".$delete_id."'";
 mysqli_query($db, $sql_query3);
 header("Location: list-race");
}

$query ="SELECT * FROM race where cid = $login_club and date_expire > sysdate() order by id desc";  
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="add-race">Add Race Schedule</a></li>
        <li><a href="list-race">Refresh</a></li>
    </div>
  </div>
</nav>
...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 style="text-align: center;" class="h3 mb-2 text-gray-800">List of Race Schedule</h1>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0"s>
                  ...
                  <form>
                          ...
                          {  
                             $noquery ="SELECT count(rid) as entry FROM race_entries where cid = $login_club and rid = '".$row["id"]."'";  
...
<br>
          ...
          <?php 
          $query ="SELECT * FROM race where cid = $login_club and date_expire < sysdate() order by date_expire desc";  
          $result = mysqli_query($db, $query);   ?>
...
function delete_id(id)
{
     ...
     {
        window.location.href='list-race?delete_id='+id;
     }
}
</script>
...
{
        window.location.href='list-race-entries?list_race='+id+'<?php
...
{
        window.location.href='view-list-race-entries?view_entries='+id+'<?php
        $codequery ="SELECT * FROM code order by rand() limit 1";  
        $coderesult = mysqli_query($db, $codequery);
        $coderow = mysqli_fetch_array($coderesult);
        $code = $coderow['code'];
...
{
        window.location.href='race-result?result_id='+id+'<?php
        $codequery ="SELECT * FROM code order by rand() limit 1";  
        $coderesult = mysqli_query($db, $codequery);
        $coderow = mysqli_fetch_array($coderesult);
        $code = $coderow['code'];
