...
<nav class="navbar navbar-inverse">
  ...
  <?php 
    ...
    $query = "select * from club_schedules where id = '$sid' and cid = '$login_club'";
...
<!--start div date end-->  
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label">Subject:</label>
        <div class="col-sm-7">
          <input style="width: 100%;" class="form-control" type="text" name="subject" value="<?php echo base64_decode($row['subject']);?>"/>           
      </div>
...
<!--start div add type-->  
    <div class="form-group">
      <label class="col-sm-3 control-label">Details:</label>
        <div class="col-sm-7">
          <textarea style="width: 100%;" class="form-control" type="text" name="detail"><?php echo base64_decode($row['description']);?></textarea>          
      </div>
...
if(isset($_POST["delete"]))
{
 ...
 $sql_query="DELETE FROM club_schedules WHERE id='".$delete_id."' and cid = '".$login_club."'";
