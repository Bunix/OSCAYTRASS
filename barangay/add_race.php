  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="list-race">Race List</a></li>       
      </ul><!--end nav-barnav-->            
    </div><!---myNavbar-->
  </div><!---container-fluid-->
</nav>  
...
<div class="container">  
  ...
  <br>
   <form class="form-horizontal" action="insert-race" method="post">
    
    <!-- start div Select race cat-->       
                          <div class="form-group">                             
                            <label class="col-sm-3 control-label">Select Race Category:</label>      
                              <div class="col-sm-7">
