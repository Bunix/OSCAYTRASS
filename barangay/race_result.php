...
<div class="container">
  ...
  <tfoot>
    ...
    <?php                        
       ...
       $dsql = "SELECT *, (TIME_TO_SEC(time_arrived) - TIME_TO_SEC(time_release))/60 as minutes, distance/((TIME_TO_SEC(time_arrived) - TIME_TO_SEC(time_release))/60) as speed FROM race_result where rid = '".$_GET['result_id']."' and cid = '".$login_club."' order by speed desc";
