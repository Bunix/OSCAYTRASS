...
$sql_query1="DELETE FROM club_officer WHERE cid='".$delete_id."'";
...
$sql_query3="DELETE FROM club_joined_members WHERE cid='".$delete_id."'";
 ...
 header("Refresh: 0; url=expired-club");
}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="expired-club">Refresh</a></li>
    </div>
  </div>
</nav>
...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">Expired Clubs</h1>
          <!-- DataTales -->
...
function delete_id(id)
{
     ...
     {
        window.location.href='expired-club?delete_id='+id;
     }
}
</script>
