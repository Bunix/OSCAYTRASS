...
$delete_id = mysqli_real_escape_string($db, $_GET["delete_id"]);
 ...
 $sql_query="DELETE FROM color WHERE id='".$delete_id."'";
 mysqli_query($db, $sql_query);
 header("Refresh: 0; url=list-color");
}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="list-color">Refresh</a></li>
        <li><a href="#myColor" data-toggle="modal">Add</a></li>
    </div>
  </div>
</nav>
...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">List of Pigeon Colors</h1>
          <!-- DataTales -->
...
<div id="myColor" class="modal fade">
  <div class="modal-dialog modal-login">
    <div class="modal-content">
      <div class="modal-header">        
        <h4 class="modal-title">Add Pigeon Color</h4> 
      ...
      <div class="modal-body">
        <form action="" method="post">
          <div class="form-group">
            <input type="text" class="form-control" name="color" placeholder="Type-in New Pigeon Color" required="required">   
          </div>
...
{
     if(confirm('Are you sure you want to delete selected color?'))
     {
        window.location.href='list-color?delete_id='+id;
     }
}
</script>
...
die("Connection failed: " . mysqli_connect_error());
    ...
    echo "<script type= 'text/javascript'>alert('New Pigeon Color Added Successfully!');</script>"; 
