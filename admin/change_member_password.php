...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <h4 align="center">Change Member Password</h4>
  ...
  <?php 
    ...
    $query = "select * from user where id = '".$decrypt_id."'";
...
<!--start div Form-->
<div class="container">   
   <form class="form-horizontal" action="update-member-password" method="post">
