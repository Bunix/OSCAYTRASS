...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="active-club-admin">Back</a></li>
    </div>
  </div>
</nav>
  ...
  <?php 
    $member_id = mysqli_escape_string($db, $_GET["renew_id"]);

    $query = "select *, date(date_subscribe) as date_sub, time(date_subscribe) as time_sub, date(date_expired) as date_exp, time(date_expired) as time_exp from user where id = '$member_id'";
...
<!--start div Form-->
<div class="container">   
   <form class="form-horizontal" action="update-club-admin-subscription" method="post">
