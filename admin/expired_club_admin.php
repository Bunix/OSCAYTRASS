...
while ( $filerow2 = mysqli_fetch_array($fileresult2)) {
 ...
 header("Refresh: 0; url=expired-subscribers");
  ...
  $query ="SELECT a.id as aid, DATEDIFF(a.date_expired,sysdate()) as days, a.un as aun, a.fullname as afullname, a.address as aaddress, a.contact_nr as acontact, a.email as aemail, a.date_subscribe as adatesub, a.date_expired as adateexp, b.club_acronym as barangay FROM user as a left join club as b on a.club_id = b.id where a.type_id = '$member_subscriber' and a.date_expired <= sysdate() order by days desc";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="expired-brgy-admin">Refresh</a></li>
    </div>
  </div>
</nav>
...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">Expired Brgy Administrator</h1>
          <!-- DataTales -->
                  ...
                  <form>
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td>'.base64_decode(strtoupper($row["club"])).'</td>
                                    <td>
            <a href="javascript:renew_id('.$row["aid"].')" class="trigger-btn" >Renew</a><br><br>
           <a href="javascript:delete_id('.$row["aid"].')" class="trigger-btn" >Deactivate </a>
                                    </td>  
                               </tr>  
                               ' ;  
                          $sno++;}  
...
{
     if(confirm('Are you sure you want to deactivate said club administrator from his/her subscription? All his/her records will be erased upon deactivation and can no longer be undone and recover.'))
     {
        window.location.href='expired-brgy-admin?delete_id='+id;
     }
}
</script>
...
{
        window.location.href='edit-club-admin-subscription?renew_id='+id+'<?php
